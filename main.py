...
from src.evaluator.artifact_evaluator import WeightBasedArtifactEvaluator as WAE, KEQING_ARTIFACT_STAT_FACTORS
...
YUANMO_ARTIFACT_STAT_FACTORS = {
    ...
    StatType.ELEMENTAL_MASTERY: 0.33,  # 元素精通
    StatType.ENERGY_RECHARGE: 1.2,  # 充能效率
}
...
CHARACTER_STAT_WEIGHTS_LEIDIAN = {
    ...
    StatType.ATK: 1,  # 攻击力
    StatType.ENERGY_RECHARGE: 1,  # 充能效率
}
